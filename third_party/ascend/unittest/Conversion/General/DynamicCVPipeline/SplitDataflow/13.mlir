...
// CHECK-LABEL: func.func @tc13_block_argument_input
// CHECK-NOT: hivm.hir.copy
// CHECK-NOT: hivm.hir.fixpipe
// CHECK: return
module {
  func.func @tc13_block_argument_input(%arg0: memref<128x128xf16>, %a: tensor<128x128xf16>, %b: tensor<128x128xf16>, %acc: tensor<128x128xf32>) {
